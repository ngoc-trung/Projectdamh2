...
">
  ...
  <!-- Custom StyleSheet -->
  <link rel="stylesheet" href="{{asset('public/fontend/css/styles.css')}}">
          ...
          <div class="nav__icons">
            <a href="#" class="icon__item">
              <svg class="icon__user">
                <use xlink:href="{{asset('public/fontend/images/sprite.svg#icon-user')}}"></use>
              </svg>
            </a>

            <a href="#" class="icon__item">
              <svg class="icon__search">
                <use xlink:href="{{asset('public/fontend/images/sprite.svg#icon-search')}}"></use>
              </svg>
            </a>

            <a href="#" class="icon__item">
              <svg class="icon__cart">
                <use xlink:href="{{asset('public/fontend/images/sprite.svg#icon-shopping-basket')}}"></use>
              </svg>
          ...
          <ul class="glide__slides">
              ...
              <div class="hero__center">
                ...
                <div class="hero__right">
                  <div class="hero__img-container">
                    <img class="banner_01" src="{{asset('public/fontend/images/banner_01.png')}}" alt="banner2" />
                  </div>
                </div>
              </div>
            </li>
            <li class="glide__slide">
              <div class="hero__center">
                ...
                <div class="hero__right">
                  <img class="banner_02" src="{{asset('public/fontend/images/banner_02.png')}}" alt="banner2" />
                </div>
              </div>
            </li>
          </ul>
        ...
        <div class="collection__container" data-aos="fade-up" data-aos-duration="1200">
          <div class="collection__box">
            <div class="img__container">
              <img class="collection_02" src="{{asset('public/fontend/images/collection_02.png')}}" alt="">
            </div>
          ...
          <div class="collection__box">
            <div class="img__container">
              <img class="collection_01" src="{{asset('public/fontend/images/collection_01.png')}}" alt="">
            </div>
            <div class="collection__content">
              <div class="collection__data">
        ...
        <div class="facility__contianer" data-aos="fade-up" data-aos-duration="1200">
          <div class="facility__box">
            <div class="facility-img__container">
              <svg>
                <use xlink:href="{{asset('public/fontend/images/sprite.svg#icon-airplane')}}"></use>
              </svg>
            </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Glide.js/3.4.1/glide.min.js"></script>
  ...
  <!-- Custom JavaScript -->
  <script src="{{asset('public/fontend/js/products.js')}}"></script>
  <script src="{{asset('public/fontend/js/index.js')}}"></script>
  <script src="{{asset('public/fontend/js/slider.js')}}"></script>
